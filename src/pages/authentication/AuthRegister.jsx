...
import {strengthColor, strengthIndicator} from '../../utils/passwordsth.js';
import {
    Box,
    Button,
    Divider,
        ...
        <>
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    firstname: Yup.string().max(255).required('Primer Nombre es requerido'),
                    lastname: Yup.string().max(255).required('Segundo nombre es requerido'),
                    email: Yup.string().email('Debe ser un email válido').max(255).required('Correo electrónico requerido'),
                ...
                {({errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values}) => (
                    <form noValidate onSubmit={handleSubmit}>
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                                <Divider>
                                    <Typography variant="caption">Crear cuenta con</Typography>
                                </Divider>
                            </Grid>
                            <Grid item xs={12}>
                            </Grid>
